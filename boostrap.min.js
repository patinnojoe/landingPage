...
!(function (t, e) {
  ...
  const i = {
    ...
    u = (t) =>
      !(!c(t) || 0 === t.getClientRects().length) && 'visible' === getComputedStyle(t).getPropertyValue('visibility'),
    g = (t) =>
      !t ||
  ...
  class et extends q {
    ...
    pause(t) {
      t || (this._isPaused = !0),
        i.findOne('.carousel-item-next, .carousel-item-prev', this._element) && (l(this._element), this.cycle(!0)),
  ...
  class bt {
    ...
    _getConfig(t) {
      return (
        ((t = { ...mt, ...('object' == typeof t ? t : {}) }).rootElement = h(t.rootElement)), d('backdrop', t, _t), t
      );
    }
    _append() {
      this._isAppended ||
  ...
  class wt extends q {
    ...
    _getConfig(t) {
      return (
        (t = { ...vt, ...V.getDataAttributes(this._element), ...('object' == typeof t ? t : {}) }), d('modal', t, yt), t
      );
    }
    _showElement(t) {
      const e = this._isAnimated(),
    ...
    _initializeOnDelegatedTarget(t, e) {
      ...
      return (
        (e = e || W.get(t.delegateTarget, s)) ||
          ((e = new this.constructor(t.delegateTarget, this._getDelegateConfig())), W.set(t.delegateTarget, s, e)),
        e
      );
    }
    _getOffset() {
  ...
  class Ft extends q {
    ...
    _getConfig(t) {
      if (
        'string' !=
          typeof (t = { ...qt, ...V.getDataAttributes(this._element), ...('object' == typeof t && t ? t : {}) })
            .target &&
        c(t.target)
      ) {
        let { id: e } = t.target;
